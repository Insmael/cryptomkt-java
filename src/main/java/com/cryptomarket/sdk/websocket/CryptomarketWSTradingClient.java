...
public interface CryptomarketWSTradingClient extends CryptomarketWS {
   ...
   * <p>
   * ContingencyType.ALL_OR_NONE must have 2 or 3 orders
   * <p>
   * ContingencyType.ONE_CANCEL_OTHER must have 2 or 3 orders
   * <p>
   * ContingencyType.ONE_TRIGGER_ONE_CANCEL_OTHER must have 3 or 4 orders
   * <p>
   ...
   * @param orderListID     order list identifier. If ommited, it will be
   *                        generated by the system. Must be equal to the client
   *                        order id of the first order in the request
  ...
  public void createSpotOrderList(
      ...
      @Nullable Callback<List<Report>> callback); // TODO check the order type class for building the query
